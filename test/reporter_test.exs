defmodule Test.Reporter do
  ...
  test "return JSON of files with some errors" do
    ...
    assert to_string(result) == ~s(\0{"type":"Issue","remediation_points":100000,"location":{"path":"bar.ex","lines":{"end":1,"begin":1}},"description":"Module without a @moduledoc detected","check_name":"ModuleDoc","categories":["Style"]}\0{"type":"Issue","remediation_points":100000,"location":{"path":"bar.ex","lines":{"end":14,"begin":14}},"description":"Comparison to a boolean is pointless","check_name":"ComparisonToBoolean","categories":["Style"]})
  end
end
